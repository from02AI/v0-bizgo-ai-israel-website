...
// Use small inline SVGs for icons to avoid lucide-react typing mismatches in this file
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <svg className="size-4 opacity-50" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
